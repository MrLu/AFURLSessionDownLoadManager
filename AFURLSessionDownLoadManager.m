                  ...
                  isResuming:(BOOL)isResuming
{
    ...
    if (self) {
        ...
        if (!self.outputStream) {
            DLog(@"%@ outputStream",NSStringFromClass(self.class));
        }
    }
    return self;
}

- (void)setProgressiveDownloadProgressBlock:(void (^)(AFURLSessionDownloadTask *task, NSInteger bytesRead, long long totalBytesRead, long long totalBytesExpected, long long totalBytesReadForFile, long long totalBytesExpectedToReadForFile)) block {
                                               ...
                                               completionHandler:(void (^)(NSURLResponse *response, id responseObject, NSError *error))completionHandler
{
    ...
    NSURLSessionDataTask *task = [self dataTaskWithRequest:mutableRequest completionHandler:completionHandler];
    AFURLSessionDownloadTask *afTask = [[AFURLSessionDownloadTask alloc]initWithTask:task targetPath:targetPath cachePath:cachePath shouldResume:shouldResume isResuming:isResuming];
